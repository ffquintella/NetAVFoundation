...
namespace AudioUnit {
	...
	public delegate void AUVoiceIOMutedSpeechActivityEventListener (AUVoiceIOSpeechActivityEvent activityEvent);
...
#else
	public delegate string AUImplementorStringFromValueCallback (AUParameter param, ref float? value);
#endif
	...
	public delegate void AURenderObserver (AudioUnitRenderActionFlags actionFlags, ref AudioTimeStamp timestamp, uint frameCount, nint outputBusNumber);
	...
	[DisableDefaultCtor]
	public partial class AUAudioUnit {
		[Static]
		[Export ("registerSubclass:asComponentDescription:name:version:")] // AUAudioUnitImplementation
		public static extern void RegisterSubclass (Class cls, AudioComponentDescription componentDescription, string name, uint version);

		[Export ("initWithComponentDescription:options:error:")]
		[DesignatedInitializer]
		public static extern NativeHandle Constructor (AudioComponentDescription componentDescription, AudioComponentInstantiationOptions options, [NullAllowed] out NSError outError);

		[Export ("initWithComponentDescription:error:")]  
		public extern NativeHandle Constructor (AudioComponentDescription componentDescription, [NullAllowed] out NSError outError);

		[Static]
		[Export ("instantiateWithComponentDescription:options:completionHandler:")]
		[Async]
		public static extern void FromComponentDescription (AudioComponentDescription componentDescription, AudioComponentInstantiationOptions options, Action<AUAudioUnit, NSError> completionHandler);

		[Export ("componentDescription")]
		public AudioComponentDescription ComponentDescription { get; }
		...
		[Export ("component")]
		public unsafe AudioComponent Component { get; }

		[NullAllowed, Export ("componentName")]
		public string? ComponentName { get; }

		[NullAllowed, Export ("audioUnitName")]
		public string AudioUnitName { get; }
		...
		public uint ComponentVersion { get; }

		[Export ("allocateRenderResourcesAndReturnError:")]
		public extern bool AllocateRenderResources ([NullAllowed] out NSError outError);

		[Export ("deallocateRenderResources")]
		public extern void DeallocateRenderResources ();

		[Export ("renderResourcesAllocated")]
		public bool RenderResourcesAllocated { get; }
		...
		public extern void RemoveRenderObserver (nint token);
		...
		public extern NSNumber [] GetParametersForOverview (nint count);
		...
		[Async]
		public extern void RequestViewController (Action<AUViewControllerBase> completionHandler);

		// AUAudioUnitImplementation
		[Export ("setRenderResourcesAllocated:")]
		public extern void SetRenderResourcesAllocated (bool flag);

		[Export ("shouldChangeToFormat:forBus:")]
		public extern bool ShouldChangeToFormat (AVAudioFormat format, AUAudioUnitBus bus);
		...
		public extern MidiCIProfileState GetProfileState (byte cable, byte channel);
		...
		public extern bool Disable (MidiCIProfile profile, byte cable, byte channel, [NullAllowed] out NSError outError);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("enableProfile:cable:onChannel:error:")]
		public extern bool Enable (MidiCIProfile profile, byte cable, byte channel, [NullAllowed] out NSError outError);
		...
		public extern bool SaveUserPreset (AUAudioUnitPreset userPreset, [NullAllowed] out NSError outError);

		[TV (13, 0), iOS (13, 0)]
		[MacCatalyst (13, 1)]
		[Export ("deleteUserPreset:error:")]
		public extern bool DeleteUserPreset (AUAudioUnitPreset userPreset, [NullAllowed] out NSError outError);

		[TV (13, 0), iOS (13, 0)]
		[MacCatalyst (13, 1)]
		[Export ("presetStateFor:error:")]
		[return: NullAllowed]
		public extern NSDictionary<NSString, NSObject> GetPresetState (AUAudioUnitPreset userPreset, [NullAllowed] out NSError outError);
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	public interface AUAudioUnitBus {
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	public interface AUAudioUnitPreset  {
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	public partial class AUParameterNode : NSObject {
		[Export ("identifier")]
		...
		public extern string GetDisplayName (nint maximumLength);

		[Export ("tokenByAddingParameterObserver:")]
		/* void * */
		public extern IntPtr TokenByAddingParameterObserver (AUParameterObserver observer);

		[Wrap ("new AUParameterObserverToken { ObserverToken = TokenByAddingParameterObserver (observer) }")]
		public extern AUParameterObserverToken CreateTokenByAddingParameterObserver (AUParameterObserver observer);

		[Export ("tokenByAddingParameterRecordingObserver:")]
		/* void * */
		public extern IntPtr TokenByAddingParameterRecordingObserver (AUParameterRecordingObserver observer);

		[Wrap ("new AUParameterObserverToken { ObserverToken = TokenByAddingParameterRecordingObserver (observer) }")]
		public extern AUParameterObserverToken CreateTokenByAddingParameterRecordingObserver (AUParameterRecordingObserver observer);
		...
		public extern void RemoveParameterObserver (/* void * */ IntPtr token);

		[Wrap ("RemoveParameterObserver (token.ObserverToken)")]
		public extern void RemoveParameterObserver (AUParameterObserverToken token);
		...
		internal extern IntPtr _GetToken (AUParameterAutomationObserver observer);

		[MacCatalyst (13, 1)]
		[Wrap ("new AUParameterObserverToken (_GetToken (observer))")]
		public extern AUParameterObserverToken GetToken (AUParameterAutomationObserver observer);
	}
