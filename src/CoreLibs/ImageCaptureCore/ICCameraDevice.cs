...
namespace ImageCaptureCore {
	partial class ICCameraDevice {
		...
		partial class DidDownloadDataFromFileAction : ICCameraDeviceDownloadDelegate {
			...
			[Export (CallbackSelector)]
			public void DidDownloadDataDelegate (ICCameraFile file, NSError error, NSDictionary<NSString, NSObject> options, IntPtr contextInfo)
			{
