...
#endif
    [Protocol]
    public  abstract partial class NSMutableCopying : NSCopying
    {

        [Export("mutableCopyWithZone:")]
        [return: Release()]
        public extern NSObject MutableCopy(NSZone? zone);

        public NSMutableCopying(IntPtr handle) : base(handle)
        {
        }
        
        public NSMutableCopying() : base()
        {
            Handle = IntPtr.Zero;
        }
    }

    public partial class INSMutableCopying { }
}