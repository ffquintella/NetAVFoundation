...
namespace AVKit {
	...
	public partial class AVPlayerViewController : NSObject {
		...
		[iOS (16, 0), MacCatalyst (16, 0), NoMac, TV (16, 0)]
		[Export ("selectSpeed:")]
		public extern void SelectSpeed (AVPlaybackSpeed speed);
	...
	[NoMacCatalyst]
	[BaseType (typeof (NSObject))]
	public partial class AVInterstitialTimeRange : NSCopying {
		[Export ("initWithTimeRange:")]
		[DesignatedInitializer]
		public extern NativeHandle Constructor (CMTimeRange timeRange);
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	public partial class AVDisplayManager: NSObject {

		[NoMacCatalyst]
		[Field ("AVDisplayManagerModeSwitchStartNotification")]
		[Notification]
		public NSString ModeSwitchStartNotification { get; }

		[NoMacCatalyst]
		[Field ("AVDisplayManagerModeSwitchEndNotification")]
		[Notification]
		public NSString ModeSwitchEndNotification { get; }

		[NoMacCatalyst]
		[Field ("AVDisplayManagerModeSwitchSettingsChangedNotification")]
		[Notification]
		public NSString ModeSwitchSettingsChangedNotification { get; }

		[NullAllowed, Export ("preferredDisplayCriteria", ArgumentSemantic.Copy)]
		public AVDisplayCriteria PreferredDisplayCriteria { get; set; }

		[Export ("displayModeSwitchInProgress")]
		public extern bool DisplayModeSwitchInProgress { [Bind ("isDisplayModeSwitchInProgress")] get; }

		[NoMacCatalyst]
		[Export ("displayCriteriaMatchingEnabled")]
		public extern  bool DisplayCriteriaMatchingEnabled { [Bind ("isDisplayCriteriaMatchingEnabled")] get; }
	}
	...
	public partial class UIWindow_AVAdditions: NSObject {

		[Export ("avDisplayManager")]
		public extern AVDisplayManager GetAVDisplayManager ();
	}
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	public partial class AVPlaybackSpeed: NSObject {
		[Static]
		[Export ("systemDefaultSpeeds")]
		AVPlaybackSpeed [] SystemDefaultSpeeds { get; }

		[Export ("initWithRate:localizedName:")]
		public extern NativeHandle Constructor (float rate, string localizedName);
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	public partial class AVCaptureEvent: NSObject {
		[Export ("phase")]
		public AVCaptureEventPhase Phase { get; }
	}
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	public partial class AVCaptureEventInteraction :  NSObject {//UIInteraction {
		[Export ("initWithEventHandler:")]
		public extern NativeHandle Constructor (Action<AVCaptureEvent> handler);

		[Export ("initWithPrimaryEventHandler:secondaryEventHandler:")]
		public extern NativeHandle Constructor (Action<AVCaptureEvent> primaryHandler, Action<AVCaptureEvent> secondaryHandler);
