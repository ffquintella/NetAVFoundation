...
namespace CoreLocation {
	...
	partial class CLHeading :  NSCopying {
	...
	[BaseType (typeof (NSObject))]
	partial class CLLocation :  NSCopying {//, CKRecordValue {
		//[Export ("coordinate")]
		...
		extern NativeHandle Constructor (double latitude, double longitude);
...
*/
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	partial class CLFloor :  NSCopying {
		[Export ("level")]
		nint Level { get; }
	}
...
*/
	...
	[Model]
	[Protocol]
	partial class CLLocationManagerDelegate {
		[NoTV]
		//[Deprecated (PlatformName.iOS, 6, 0)]
		[MacCatalyst (13, 1)]
		[Deprecated (PlatformName.MacCatalyst, 13, 1)]
		[Export ("locationManager:didUpdateToLocation:fromLocation:"), EventArgs ("CLLocationUpdated")]
		extern void UpdatedLocation (CLLocationManager manager, CLLocation newLocation, CLLocation oldLocation);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:didUpdateHeading:"), EventArgs ("CLHeadingUpdated")]
		extern void UpdatedHeading (CLLocationManager manager, CLHeading newHeading);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManagerShouldDisplayHeadingCalibration:"), DelegateName ("CLLocationManagerEventArgs"), DefaultValue (true)]
		extern bool ShouldDisplayHeadingCalibration (CLLocationManager manager);

		[Export ("locationManager:didFailWithError:"), EventArgs ("NSError", true)]
		extern void Failed (CLLocationManager manager, NSError error);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:didEnterRegion:"), EventArgs ("CLRegion")]
		extern void RegionEntered (CLLocationManager manager, CLRegion region);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:didExitRegion:"), EventArgs ("CLRegion")]
		extern void RegionLeft (CLLocationManager manager, CLRegion region);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:monitoringDidFailForRegion:withError:"), EventArgs ("CLRegionError")]
		extern void MonitoringFailed (CLLocationManager manager, [NullAllowed] CLRegion region, NSError error);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:didStartMonitoringForRegion:"), EventArgs ("CLRegion")]
		extern void DidStartMonitoringForRegion (CLLocationManager manager, CLRegion region);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:didDetermineState:forRegion:"), EventArgs ("CLRegionStateDetermined")]
		extern void DidDetermineState (CLLocationManager manager, CLRegionState state, CLRegion region);
		...
		extern void DidRangeBeacons (CLLocationManager manager, CLBeacon [] beacons, CLBeaconRegion region);

		[NoTV, iOS (13, 0)]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:didRangeBeacons:satisfyingConstraint:")]
		[EventArgs ("CLRegionBeaconsConstraintRanged")]
		extern void DidRangeBeaconsSatisfyingConstraint (CLLocationManager manager, CLBeacon [] beacons, CLBeaconIdentityConstraint beaconConstraint);
		...
		extern void RangingBeaconsDidFailForRegion (CLLocationManager manager, CLBeaconRegion region, NSError error);

		[NoTV, iOS (13, 0)]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:didFailRangingBeaconsForConstraint:error:")]
		[EventArgs ("CLRegionBeaconsConstraintFailed")]
		extern void DidFailRangingBeacons (CLLocationManager manager, CLBeaconIdentityConstraint beaconConstraint, NSError error);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:didVisit:"), EventArgs ("CLVisited")]
		extern void DidVisit (CLLocationManager manager, CLVisit visit);
		...
		//extern void AuthorizationChanged (CLLocationManager manager, CLAuthorizationStatus status);

		[Export ("locationManager:didUpdateLocations:"), EventArgs ("CLLocationsUpdated")]
		extern void LocationsUpdated (CLLocationManager manager, CLLocation [] locations);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManagerDidPauseLocationUpdates:"), EventArgs ("")]
		extern void LocationUpdatesPaused (CLLocationManager manager);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManagerDidResumeLocationUpdates:"), EventArgs ("")]
		extern void LocationUpdatesResumed (CLLocationManager manager);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("locationManager:didFinishDeferredUpdatesWithError:"), EventArgs ("NSError", true)]
		extern void DeferredUpdatesFinished (CLLocationManager manager, [NullAllowed] NSError error);

		[TV (14, 0), iOS (14, 0)]
		[MacCatalyst (14, 0)]
		[Export ("locationManagerDidChangeAuthorization:")]
		extern void DidChangeAuthorization (CLLocationManager manager);

	}

	[Static]
	partial class CLLocationDistance {
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor] // will crash, see CoreLocation.cs for compatibility stubs
	partial class CLRegion : NSCopying {
		/*
		[NoTV]
...
*/
	...
	class CLPlacemark :  NSCopying {
		...
		extern NativeHandle Constructor (CLPlacemark placemark);
	...
	[DisableDefaultCtor]
#endif
	partial class CLCircularRegion {
/*
	...
	partial class CLBeaconRegion {
		...
		extern NativeHandle Constructor (NSUuid proximityUuid, string identifier);
		...
		extern IntPtr _Constructor (NSUuid uuid, string identifier);
		...
		extern NativeHandle Constructor (NSUuid proximityUuid, ushort major, string identifier);

		[iOS (13, 0)]
		[MacCatalyst (13, 1)]
		[Internal] // signature conflict with deprecated API
		[Export ("initWithUUID:major:identifier:")]
		extern IntPtr _Constructor (NSUuid uuid, ushort major, string identifier);
		...
		extern NativeHandle Constructor (NSUuid proximityUuid, ushort major, ushort minor, string identifier);

		[iOS (13, 0)]
		[MacCatalyst (13, 1)]
		[Internal] // signature conflict with deprecated API
		[Export ("initWithUUID:major:minor:identifier:")]
		extern IntPtr _Constructor (NSUuid uuid, ushort major, ushort minor, string identifier);

		[iOS (13, 0)]
		[MacCatalyst (13, 1)]
		[Export ("initWithBeaconIdentityConstraint:identifier:")]
		extern NativeHandle Constructor (CLBeaconIdentityConstraint beaconIdentityConstraint, string identifier);

		[Export ("peripheralDataWithMeasuredPower:")]
		extern NSMutableDictionary GetPeripheralData ([NullAllowed] NSNumber measuredPower);
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	partial class CLBeacon : NSCopying {
	...
	class CLGeocoder: NSObject {
		...
		[Async]
		extern void ReverseGeocodeLocation (CLLocation location, CLGeocodeCompletionHandler completionHandler);

		[MacCatalyst (13, 1)]
		[Export ("reverseGeocodeLocation:preferredLocale:completionHandler:")]
		[Async]
		extern void ReverseGeocodeLocation (CLLocation location, [NullAllowed] NSLocale locale, CLGeocodeCompletionHandler completionHandler);
		...
		[Async]
		extern void GeocodeAddress (NSDictionary addressDictionary, CLGeocodeCompletionHandler completionHandler);

		[Export ("geocodeAddressString:completionHandler:")]
		[Async]
		extern void GeocodeAddress (string addressString, CLGeocodeCompletionHandler completionHandler);

		[Export ("geocodeAddressString:inRegion:completionHandler:")]
		[Async]
		extern void GeocodeAddress (string addressString, [NullAllowed] CLRegion region, CLGeocodeCompletionHandler completionHandler);

		[MacCatalyst (13, 1)]
		[Async]
		[Export ("geocodeAddressString:inRegion:preferredLocale:completionHandler:")]
		extern void GeocodeAddress (string addressString, [NullAllowed] CLRegion region, [NullAllowed] NSLocale locale, CLGeocodeCompletionHandler completionHandler);

		[Export ("cancelGeocode")]
		extern void CancelGeocode ();
	...
	partial class CLBeaconIdentityConstraint : NSCopying {

		[Export ("initWithUUID:")]
		extern NativeHandle Constructor (NSUuid uuid);

		[Export ("initWithUUID:major:")]
		extern NativeHandle Constructor (NSUuid uuid, ushort major);

		[Export ("initWithUUID:major:minor:")]
		extern NativeHandle Constructor (NSUuid uuid, ushort major, ushort minor);
...
#endif
	[Protocol]
	partial class CLLocationPushServiceExtension {
		[Abstract]
		[Export ("didReceiveLocationPushPayload:completion:")]
		extern void DidReceiveLocationPushPayload (NSDictionary<NSString, NSObject> payload, Action completion);

		[Export ("serviceExtensionWillTerminate")]
		extern void ServiceExtensionWillTerminate ();
	}

	[TV (15, 0), iOS (15, 0), MacCatalyst (15, 0)]
	[BaseType (typeof (NSObject))]
	partial class CLLocationSourceInformation : NSCopying {
		[Export ("initWithSoftwareSimulationState:andExternalAccessoryState:")]
		extern NativeHandle Constructor (bool isSoftware, bool isAccessory);
	...
	[BaseType (typeof (NSObject))]
	//[DisableDefaultCtor]
	partial class CLMonitoringRecord : NSSecureCoding {
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	partial class CLMonitoringEvent : NSSecureCoding {
	...
	[NoTV, Mac (14, 0), iOS (17, 0), MacCatalyst (17, 0)]
	[BaseType (typeof (NSObject))]
	partial class CLMonitorConfiguration: NSObject {
		[Export ("name")]
		string Name { get; }
		...
		static extern CLMonitorConfiguration Create (string name, DispatchQueue queue, Action<CLMonitor, CLMonitoringEvent> eventHandler);
	}

	[NoTV, Mac (14, 0), iOS (17, 0), MacCatalyst (17, 0)]
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	partial class CLMonitor {
		[Async]
		[Static]
		[Export ("requestMonitorWithConfiguration:completion:")]
		static extern void RequestMonitor (CLMonitorConfiguration config, Action<CLMonitor> completionHandler);
		...
		extern void AddCondition (CLCondition condition, string identifier);

		[Export ("addConditionForMonitoring:identifier:assumedState:")]
		extern void AddCondition (CLCondition condition, string identifier, CLMonitoringState state);

		[Export ("removeConditionFromMonitoringWithIdentifier:")]
		extern void RemoveCondition (string identifier);

		[Export ("monitoringRecordForIdentifier:")]
		[return: NullAllowed]
		extern CLMonitoringRecord? GetMonitoringRecord (string identifier);
	}
	...
	[NoTV, Mac (14, 0), iOS (17, 0), MacCatalyst (17, 0)]
	[BaseType (typeof (NSObject))]
	partial class CLCondition :  NSCopying { }

	[NoTV, Mac (14, 0), iOS (17, 0), MacCatalyst (17, 0)]
	[BaseType (typeof (CLCondition))]
	partial class CLCircularGeographicCondition : NSSecureCoding {
		//[Export ("center")]
		///CLLocationCoordinate2D Center { get; }
	...
	[BaseType (typeof (CLCondition))]
	[DisableDefaultCtor]
	partial class CLBeaconIdentityCondition : NSCopying {
		[Export ("UUID", ArgumentSemantic.Copy)]
		NSUuid Uuid { get; }
