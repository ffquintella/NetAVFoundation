...
namespace Intents {
	...
	public partial class NSUnitTemperature : NSUnit { }
	public partial class  NSUnitVolume : NSUnit { }
	public partial class  NSUnitSpeed : NSUnit { }
	public partial class  NSUnitEnergy : NSUnit { }
	public partial class  NSUnitMass : NSUnit { }
	public partial class  NSUnitPower : NSUnit { }
	...
	partial class INBookRestaurantReservationIntent : NSCopying {
		[MacCatalyst (13, 1)]
...
#if NET
		extern NativeHandle Constructor (INRestaurant restaurant, NSDateComponents bookingDateComponents, nuint partySize, [NullAllowed] string bookingIdentifier, [NullAllowed] INRestaurantGuest guest, [NullAllowed] INRestaurantOffer selectedOffer, [NullAllowed] string guestProvidedSpecialRequestText);
#else
	...
	[DisableDefaultCtor]
	public interface INBooleanResolutionResult {
	...
	[BaseType (typeof (INIntentResolutionResult))]
	[DisableDefaultCtor]
	public interface INCallRecordTypeResolutionResult {
	...
	[DisableDefaultCtor]
	partial class INCurrencyAmount : NSCopying {

		[Export ("initWithAmount:currencyCode:")]
		[DesignatedInitializer]
		extern NativeHandle Constructor (NSDecimalNumber amount, string currencyCode);
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	public partial class INDateComponentsRange : NSCopying {

		[Export ("initWithStartDateComponents:endDateComponents:")]
		extern NativeHandle Constructor ([NullAllowed] NSDateComponents startDateComponents, [NullAllowed] NSDateComponents endDateComponents);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Export ("initWithEKRecurrenceRule:")]
		extern NativeHandle Constructor (EKRecurrenceRule recurrenceRule);
		...
		[DesignatedInitializer]
		extern NativeHandle Constructor ([NullAllowed] NSDateComponents startDateComponents, [NullAllowed] NSDateComponents endDateComponents, [NullAllowed] INRecurrenceRule recurrenceRule);
	...
	[BaseType (typeof (INIntentResolutionResult))]
	[DisableDefaultCtor]
	public interface INDateComponentsRangeResolutionResult {
	...
	[Protocol]
	interface INCallsDomainHandling : INStartAudioCallIntentHandling, INSearchCallHistoryIntentHandling, INStartVideoCallIntentHandling
	{
	}
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (INIntent))]
	partial class INGetAvailableRestaurantReservationBookingsIntent : NSCopying {
		...
		extern NativeHandle Constructor (INRestaurant restaurant, nuint partySize, [NullAllowed] NSDateComponents preferredBookingDateComponents, [NullAllowed] NSNumber maximumNumberOfResults, [NullAllowed] NSDate earliestBookingDateForResults, [NullAllowed] NSDate latestBookingDateForResults);
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (INIntent))]
	partial class INGetUserCurrentRestaurantReservationBookingsIntent : NSCopying {

		[MacCatalyst (13, 1)]
		[Export ("initWithRestaurant:reservationIdentifier:maximumNumberOfResults:earliestBookingDateForResults:")]
		extern NativeHandle Constructor ([NullAllowed] INRestaurant restaurant, [NullAllowed] string reservationIdentifier, [NullAllowed] NSNumber maximumNumberOfResults, [NullAllowed] NSDate earliestBookingDateForResults);

		[MacCatalyst (13, 1)]
		[Wrap ("this (restaurant, reservationIdentifier, NSNumber.FromNInt (maximumNumberOfResults), earliestBookingDateForResults)")]
		extern NativeHandle Constructor ([NullAllowed] INRestaurant restaurant, [NullAllowed] string reservationIdentifier, nint maximumNumberOfResults, [NullAllowed] NSDate earliestBookingDateForResults);
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	partial class INImage : NSCopying {

		[Static]
		[Export ("imageNamed:")]
		static extern INImage FromName (string name);

		[NoTV, NoiOS, Mac (13, 0)]
		[NoMacCatalyst]
		[Static]
		[Export ("imageWithNSImage:")]
		static extern INImage FromImage (NSImage image);

		[NoMac, iOS (14, 0)]
		[MacCatalyst (14, 0)]
		[Static]
		[Export ("systemImageNamed:")]
		static extern INImage FromSystem (string systemImageName);

		[Static]
		[Export ("imageWithImageData:")]
		static extern INImage FromData (NSData imageData);

		[Static]
		[MarshalNativeExceptions]
		[return: NullAllowed]
		[Export ("imageWithURL:")]
		static extern INImage FromUrl (NSUrl url);

		[MacCatalyst (13, 1)]
		[Static]
		[Export ("imageWithURL:width:height:")]
		[return: NullAllowed]
		static extern INImage FromUrl (NSUrl url, double width, double height);
		...
		static extern INImage FromImage (CGImage image);

		[NoMac, NoTV]
		[NoMacCatalyst]
		[Static]
		[Export ("imageWithUIImage:")]
		static extern INImage FromImage (UIImage image);

		[NoMac, NoTV]
		[NoMacCatalyst]
		[Static]
		[Export ("imageSizeForIntentResponse:")]
		static extern CGSize GetImageSize (INIntentResponse response);

		[NoMac, NoTV]
		[NoMacCatalyst]
		[Async]
		[Export ("fetchUIImageWithCompletion:")]
		static extern void FetchImage (Action<UIImage> completion);
	}
	...
	//[Abstract]
	[BaseType (typeof (NSObject))]
	partial class INIntent : NSCopying {
		...
		extern void SetImage ([NullAllowed] INImage image, string parameterName);

		[MacCatalyst (13, 1)]
		[Export ("imageForParameterNamed:")]
		[return: NullAllowed]
		extern INImage? GetImage (string parameterName);

		[MacCatalyst (13, 1)]
		[return: NullAllowed]
		[Export ("keyImage")]
		extern INImage? GetKeyImage ();
	}

	[TV (15, 0), iOS (15, 0), MacCatalyst (15, 0)]
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	partial class INIntentDonationMetadata : NSCopying {
	}
	...
	//[Abstract]
	[BaseType (typeof (NSObject))]
	partial class INIntentResponse : NSCopying {
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntentResolutionResult))]
	partial class INRestaurantResolutionResult {

		[Static]
		[Export ("successWithResolvedRestaurant:")]
		static extern INRestaurantResolutionResult GetSuccess (INRestaurant resolvedRestaurant);

		[Static]
		[Export ("disambiguationWithRestaurantsToDisambiguate:")]
		static extern INRestaurantResolutionResult GetDisambiguation (INRestaurant [] restaurantsToDisambiguate);

		[Static]
		[Export ("confirmationRequiredWithRestaurantToConfirm:")]
		static extern INRestaurantResolutionResult GetConfirmationRequired ([NullAllowed] INRestaurant restaurantToConfirm);
		...
		[Static]
		[Export ("unsupportedWithReason:")]
		static extern INRestaurantResolutionResult GetUnsupported (nint reason);
		...
		[Static]
		[Export ("confirmationRequiredWithItemToConfirm:forReason:")]
		static extern INRestaurantResolutionResult GetConfirmationRequired (NSObject itemToConfirm, nint reason);
	}
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	partial class INRestaurant :  NSCopying {

		[Export ("initWithLocation:name:vendorIdentifier:restaurantIdentifier:")]
		[DesignatedInitializer]
		extern NativeHandle Constructor (CLLocation location, string name, string vendorIdentifier, string restaurantIdentifier);
	...
	partial class INRestaurantReservationUserBooking : NSCopying {

		[Export ("initWithRestaurant:bookingDate:partySize:bookingIdentifier:")]
		[DesignatedInitializer]
		extern NativeHandle Constructor (INRestaurant restaurant, NSDate bookingDate, nuint partySize, string bookingIdentifier);

		[Export ("initWithRestaurant:bookingDate:partySize:bookingIdentifier:guest:status:dateStatusModified:")]
		extern NativeHandle Constructor (INRestaurant restaurant, NSDate bookingDate, nuint partySize, string bookingIdentifier, INRestaurantGuest guest, INRestaurantReservationUserBookingStatus status, NSDate dateStatusModified);
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	partial class INRestaurantReservationBooking :  NSCopying {
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	public partial class INPerson : INSpeakable {

		[Export ("initWithPersonHandle:nameComponents:displayName:image:contactIdentifier:customIdentifier:")]
		extern NativeHandle Constructor (INPersonHandle personHandle, [NullAllowed] NSPersonNameComponents nameComponents, [NullAllowed] string displayName, [NullAllowed] INImage image, [NullAllowed] string contactIdentifier, [NullAllowed] string customIdentifier);

		[iOS (14, 0)]
		[MacCatalyst (14, 0)]
		[Export ("initWithPersonHandle:nameComponents:displayName:image:contactIdentifier:customIdentifier:relationship:")]
		extern NativeHandle Constructor (INPersonHandle personHandle, [NullAllowed] NSPersonNameComponents nameComponents, [NullAllowed] string displayName, [NullAllowed] INImage image, [NullAllowed] string contactIdentifier, [NullAllowed] string customIdentifier, [NullAllowed] string relationship);

		[MacCatalyst (13, 1)]
		[Export ("initWithPersonHandle:nameComponents:displayName:image:contactIdentifier:customIdentifier:isMe:")]
		[DesignatedInitializer]
		extern NativeHandle Constructor (INPersonHandle personHandle, [NullAllowed] NSPersonNameComponents nameComponents, [NullAllowed] string displayName, [NullAllowed] INImage image, [NullAllowed] string contactIdentifier, [NullAllowed] string customIdentifier, bool isMe);

		[Internal]
		[iOS (15, 0), MacCatalyst (15, 0)]
		[Export ("initWithPersonHandle:nameComponents:displayName:image:contactIdentifier:customIdentifier:isMe:suggestionType:")]
		extern IntPtr InitWithMe (INPersonHandle personHandle, [NullAllowed] NSPersonNameComponents nameComponents, [NullAllowed] string displayName, [NullAllowed] INImage image, [NullAllowed] string contactIdentifier, [NullAllowed] string customIdentifier, bool isMe, INPersonSuggestionType suggestionType);
		...
		extern IntPtr InitWithContactSuggestion (INPersonHandle personHandle, [NullAllowed] NSPersonNameComponents nameComponents, [NullAllowed] string displayName, [NullAllowed] INImage image, [NullAllowed] string contactIdentifier, [NullAllowed] string customIdentifier, bool isContactSuggestion, INPersonSuggestionType suggestionType);
		...
		extern NativeHandle Constructor (INPersonHandle personHandle, [NullAllowed] NSPersonNameComponents nameComponents, [NullAllowed] string displayName, [NullAllowed] INImage image, [NullAllowed] string contactIdentifier, [NullAllowed] string customIdentifier, [NullAllowed] INPersonHandle [] aliases, INPersonSuggestionType suggestionType);
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	partial class INRestaurantOffer :  NSCopying {
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	public partial class INSpeakableString : INSpeakable {

		[MacCatalyst (13, 1)]
		[Internal]
		[Export ("initWithVocabularyIdentifier:spokenPhrase:pronunciationHint:")]
		extern IntPtr InitWithVocabularyIdentifier (string vocabularyIdentifier, string spokenPhrase, [NullAllowed] string pronunciationHint);

		[NoTV]
		[MacCatalyst (13, 1)]
		[Internal]
		[Export ("initWithIdentifier:spokenPhrase:pronunciationHint:")]
		extern IntPtr InitWithIdentifier (string identifier, string spokenPhrase, [NullAllowed] string pronunciationHint);

		[MacCatalyst (13, 1)]
		[Export ("initWithSpokenPhrase:")]
		extern NativeHandle Constructor (string spokenPhrase);
	}
	
	interface IINSpeakable: INativeObject { }

	[TV (14, 0)]
	[MacCatalyst (13, 1)]
	[Protocol]
	public partial class INSpeakable {
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	partial class INRecurrenceRule : NSCopying {

		[Export ("initWithInterval:frequency:")]
		extern NativeHandle Constructor (nuint interval, INRecurrenceFrequency frequency);

		[NoMac, iOS (14, 0)]
		[MacCatalyst (14, 0)]
		[Export ("initWithInterval:frequency:weeklyRecurrenceDays:")]
		[DesignatedInitializer]
		extern NativeHandle Constructor (nuint interval, INRecurrenceFrequency frequency, INDayOfWeekOptions weeklyRecurrenceDays);
	...
	interface INStartAudioCallIntentHandling {
		...
		extern void HandleStartAudioCall (INStartAudioCallIntent intent, Action<INStartAudioCallIntentResponse> completion);
		...
		extern void ResolveDestinationType (INStartAudioCallIntent intent, Action<INCallDestinationTypeResolutionResult> completion);

		[Export ("resolveContactsForStartAudioCall:withCompletion:")]
		extern void ResolveContacts (INStartAudioCallIntent intent, Action<INPersonResolutionResult []> completion);
	}
	...
	interface INActivateCarSignalIntentHandling {
		...
		extern void HandleActivateCarSignal (INActivateCarSignalIntent intent, Action<INActivateCarSignalIntentResponse> completion);
		...
		extern void ResolveCarName (INActivateCarSignalIntent intent, Action<INSpeakableStringResolutionResult> completion);

		[Export ("resolveSignalsForActivateCarSignal:withCompletion:")]
		extern void ResolveSignals (INActivateCarSignalIntent intent, Action<INCarSignalOptionsResolutionResult> completion);
	}
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	partial class INTermsAndConditions :  NSCopying {

		[Export ("initWithLocalizedTermsAndConditionsText:privacyPolicyURL:termsAndConditionsURL:")]
		[DesignatedInitializer]
		extern NativeHandle Constructor (string localizedTermsAndConditionsText, [NullAllowed] NSUrl privacyPolicyUrl, [NullAllowed] NSUrl termsAndConditionsUrl);
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (NSObject))]
	partial class INRestaurantGuestDisplayPreferences :  NSCopying {
	...
	partial class INRideStatus : NSCopying{
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	partial class INPersonHandle : NSCopying{
		...
		extern NativeHandle Constructor (string value, INPersonHandleType type, INPersonHandleLabel label);

		[DesignatedInitializer]
		[MacCatalyst (13, 1)]
		[Export ("initWithValue:type:label:"), Protected]
		extern NativeHandle Constructor ([NullAllowed] string value, INPersonHandleType type, [NullAllowed] NSString stringLabel);

		[Export ("initWithValue:type:")]
		extern NativeHandle Constructor ([NullAllowed] string value, INPersonHandleType type);
	}
	...
	[BaseType (typeof (INIntentResolutionResult))]
	[DisableDefaultCtor]
	public interface INPersonResolutionResult {
	...
	[Deprecated (PlatformName.MacCatalyst, 15, 0)]
	[BaseType (typeof (INIntent))]
	public interface INSearchCallHistoryIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INSearchCallHistoryIntentResponse {
	...
	[BaseType (typeof (INIntentResolutionResult))]
	[DisableDefaultCtor]
	public interface INCallRecordTypeOptionsResolutionResult {
	...
	[Deprecated (PlatformName.MacCatalyst, 13, 1, message: "Use 'INStartCallIntent' instead.")]
	[BaseType (typeof (INIntent))]
	public interface INStartVideoCallIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INStartVideoCallIntentResponse {
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntent))]
	public interface INSetCarLockStatusIntent {
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntentResponse))]
	public interface INSetCarLockStatusIntentResponse {
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntent))]
	public interface INGetCarLockStatusIntent {
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntentResponse))]
	public interface INGetCarLockStatusIntentResponse {
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntent))]
	public interface INGetCarPowerLevelStatusIntent {
	...
	public interface IINGetCarPowerLevelStatusIntentResponseObserver { }
	...
	public partial class NSUnitLength : NSUnit { }
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntentResponse))]
	public interface INGetCarPowerLevelStatusIntentResponse {
	...
	[Deprecated (PlatformName.MacCatalyst, 15, 0)]
	[BaseType (typeof (INIntent))]
	public interface INSetAudioSourceInCarIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INSetAudioSourceInCarIntentResponse {
	...
	[BaseType (typeof (INIntentResolutionResult))]
	[DisableDefaultCtor]
	public interface INRelativeReferenceResolutionResult {
	...
	[Deprecated (PlatformName.MacCatalyst, 15, 0)]
	[BaseType (typeof (INIntent))]
	public interface INSetClimateSettingsInCarIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INSetClimateSettingsInCarIntentResponse {
	...
	[BaseType (typeof (INIntentResolutionResult))]
	[DisableDefaultCtor]
	public interface INRelativeSettingResolutionResult {
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntentResolutionResult))]
	public interface INTemperatureResolutionResult {
	...
	[Deprecated (PlatformName.MacCatalyst, 15, 0)]
	[BaseType (typeof (INIntent))]
	public interface INSetDefrosterSettingsInCarIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INSetDefrosterSettingsInCarIntentResponse {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INSetSeatSettingsInCarIntentResponse {
	...
	[Deprecated (PlatformName.MacCatalyst, 15, 0)]
	[BaseType (typeof (INIntent))]
	public interface INSetProfileInCarIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INSetProfileInCarIntentResponse {
	...
	[Deprecated (PlatformName.MacCatalyst, 15, 0)]
	[BaseType (typeof (INIntent))]
	public interface INSaveProfileInCarIntent {
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (INIntent))]
	public interface INStartWorkoutIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INStartWorkoutIntentResponse {
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntentResolutionResult))]
	public interface INWorkoutGoalUnitTypeResolutionResult {
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	public partial class INCallRecord : NSCopying {
		...
		[DesignatedInitializer]
		extern NativeHandle Constructor (string identifier, [NullAllowed] NSDate dateCreated, INCallRecordType callRecordType, INCallCapability callCapability, [NullAllowed][BindAs (typeof (double?))] NSNumber callDuration, [NullAllowed][BindAs (typeof (bool?))] NSNumber unseen, [NullAllowed] INPerson [] participants, [NullAllowed][BindAs (typeof (int?))] NSNumber numberOfCalls, [NullAllowed][BindAs (typeof (bool?))] NSNumber isCallerIdBlocked);
		...
		extern NativeHandle Constructor (string identifier, [NullAllowed] NSDate dateCreated, [NullAllowed] INPerson caller, INCallRecordType callRecordType, INCallCapability callCapability, [NullAllowed][BindAs (typeof (double?))] NSNumber callDuration, [NullAllowed][BindAs (typeof (bool?))] NSNumber unseen, [NullAllowed][BindAs (typeof (int?))] NSNumber numberOfCalls);

		[iOS (14, 5)]
		[MacCatalyst (14, 5)]
		[Export ("initWithIdentifier:dateCreated:callRecordType:callCapability:callDuration:unseen:numberOfCalls:")]
		extern NativeHandle Constructor (string identifier, [NullAllowed] NSDate dateCreated, INCallRecordType callRecordType, INCallCapability callCapability, [NullAllowed][BindAs (typeof (double?))] NSNumber callDuration, [NullAllowed][BindAs (typeof (bool?))] NSNumber unseen, [NullAllowed][BindAs (typeof (int?))] NSNumber numberOfCalls);
		...
		extern NativeHandle Constructor (string identifier, [NullAllowed] NSDate dateCreated, [NullAllowed] INPerson caller, INCallRecordType callRecordType, INCallCapability callCapability, [NullAllowed] NSNumber callDuration, [NullAllowed] NSNumber unseen);

		[iOS (14, 5)]
		[MacCatalyst (14, 5)]
		[Export ("initWithIdentifier:dateCreated:callRecordType:callCapability:callDuration:unseen:")]
		extern NativeHandle Constructor (string identifier, [NullAllowed] NSDate dateCreated, INCallRecordType callRecordType, INCallCapability callCapability, [NullAllowed][BindAs (typeof (double?))] NSNumber callDuration, [NullAllowed][BindAs (typeof (bool?))] NSNumber unseen);
	...
	[DisableDefaultCtor]
	[BaseType (typeof (INIntentResolutionResult))]
	public interface INWorkoutLocationTypeResolutionResult {
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (INIntent))]
	public interface INPauseWorkoutIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INPauseWorkoutIntentResponse {
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (INIntent))]
	public interface INResumeWorkoutIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INResumeWorkoutIntentResponse {
	...
	[Deprecated (PlatformName.MacCatalyst, 15, 0)]
	[BaseType (typeof (INIntent))]
	public interface INSetRadioStationIntent {
	...
	[BaseType (typeof (INIntentResponse))]
	[DisableDefaultCtor]
	public interface INSetRadioStationIntentResponse {
	...
	[BaseType (typeof (INIntentResolutionResult))]
	[DisableDefaultCtor]
	public interface INRadioTypeResolutionResult {
	...
	[MacCatalyst (13, 1)]
	[BaseType (typeof (INIntent))]
	public interface INSendMessageIntent { //}: UNNotificationContentProviding {
	...
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	public interface INSendMessageAttachment {
	...
	[BaseType (typeof (INIntent))]
	[DisableDefaultCtor]
	interface INPlayMediaIntent: INativeObject {
	...
	[BaseType (typeof (INMediaItemResolutionResult))]
	[DisableDefaultCtor]
	interface INPlayMediaMediaItemResolutionResult: INativeObject {
	...
	[BaseType (typeof (INPersonResolutionResult))]
	[DisableDefaultCtor]
	interface INStartCallContactResolutionResult: INativeObject {
	...
	[BaseType (typeof (INMediaItemResolutionResult))]
	[DisableDefaultCtor]
	interface INUpdateMediaAffinityMediaItemResolutionResult: INativeObject {
