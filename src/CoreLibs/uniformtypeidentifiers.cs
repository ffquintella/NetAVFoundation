...
namespace UniformTypeIdentifiers {
	...
	[DisableDefaultCtor]
	public partial class UTType : NSCopying {

		[Static]
		[Export ("typeWithIdentifier:")]
		[return: NullAllowed]
		public static extern UTType CreateFromIdentifier (string identifier);

		[Static]
		[Export ("typeWithFilenameExtension:")]
		[return: NullAllowed]
		public static extern UTType CreateFromExtension (string filenameExtension);

		[Static]
		[Export ("typeWithFilenameExtension:conformingToType:")]
		[return: NullAllowed]
		public static extern UTType CreateFromExtension (string filenameExtension, UTType supertype);

		[Static]
		[Export ("typeWithMIMEType:")]
		[return: NullAllowed]
		public static extern UTType CreateFromMimeType (string mimeType);

		[Static]
		[Export ("typeWithMIMEType:conformingToType:")]
		[return: NullAllowed]
		public static extern UTType CreateFromMimeType (string mimeType, UTType supertype);

		[Export ("identifier")]
		public static string Identifier { get; }

		[NullAllowed, Export ("preferredFilenameExtension")]
		public static string PreferredFilenameExtension { get; }

		[NullAllowed, Export ("preferredMIMEType")]
		public static string PreferredMimeType { get; }

		[NullAllowed, Export ("localizedDescription")]
		public static string LocalizedDescription { get; }

		[NullAllowed, Export ("version")]
		public static NSNumber Version { get; }

		[NullAllowed, Export ("referenceURL")]
		public static NSUrl ReferenceUrl { get; }

		[Export ("dynamic")]
		public static bool Dynamic { [Bind ("isDynamic")] get; }

		[Export ("declared")]
		public static bool Declared { [Bind ("isDeclared")] get; }

		[Export ("publicType")]
		public static bool PublicType { [Bind ("isPublicType")] get; }

		// @interface LocalConstants (UTType)

		[Static]
		[Export ("exportedTypeWithIdentifier:")]
		public static extern UTType CreateExportedType (string identifier);

		[Static]
		[Export ("exportedTypeWithIdentifier:conformingToType:")]
		public static extern UTType CreateExportedType (string identifier, UTType parentType);

		[Static]
		[Export ("importedTypeWithIdentifier:")]
		public static extern UTType CreateImportedType (string identifier);

		[Static]
		[Export ("importedTypeWithIdentifier:conformingToType:")]
		public static extern UTType CreateImportedType (string identifier, UTType parentType);
		...
		[return: NullAllowed]
		public static extern UTType GetType (string tag, NSString tagClass, [NullAllowed] UTType supertype);

		[Static]
		[Wrap ("GetType (tag, tagClass.GetConstant ()!, supertype)")]
		[return: NullAllowed]
		public static extern UTType GetType (string tag, UTTagClass tagClass, [NullAllowed] UTType supertype);

		[Static]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("typesWithTag:tagClass:conformingToType:")]
		public static extern UTType [] GetTypes (string tag, NSString tagClass, [NullAllowed] UTType supertype);

		[Static]
		[Wrap ("GetTypes (tag, tagClass.GetConstant ()!, supertype)")]
		public static extern UTType [] GetTypes (string tag, UTTagClass tagClass, [NullAllowed] UTType supertype);

		[Export ("tags")]
		public static NSDictionary<NSString, NSArray<NSString>> Tags { get; }

		// @interface Conformance (UTType)

		[Export ("conformsToType:")]
		public extern  bool ConformsTo (UTType type);

		[Export ("isSupertypeOfType:")]
		public extern bool IsSupertypeOf (UTType type);

		[Export ("isSubtypeOfType:")]
		public extern bool IsSubtypeOf (UTType type);

		[Export ("supertypes")]
		public extern NSSet<UTType> Supertypes { get; }
		...
		public static extern UTType SHCustomCatalogContentType { get; }

		[Static]
		//[TV (16, 0), Mac (13, 0), iOS (16, 0), MacCatalyst (16, 0)]
		[Export ("SHSignatureContentType", ArgumentSemantic.Strong)]
		public static extern UTType SHSignatureContentType { get; }
	}
