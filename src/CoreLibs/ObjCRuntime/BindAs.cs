...
namespace ObjCRuntime {
	...
	static class BindAs {
		...
		unsafe static IntPtr ConvertManagedArrayToNSArray<T> (T[]? array, delegate*<T, IntPtr> convert) where T: class, INativeObject
		{
			if (array is null)
				return IntPtr.Zero;
		...
		unsafe static IntPtr ConvertManagedArrayToNSArray2<T,U> (T[]? array, delegate*<T, U> convert1, delegate*<U, IntPtr> convert2) where T: class, INativeObject
		{
			if (array is null)
				return IntPtr.Zero;
